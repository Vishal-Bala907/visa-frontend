...
export const featuresFour = [
  {
    ...
    text: "With years of experience, our visa experts ensure accurate documentation and timely submissions",
  },
  {
    id: 2,
    iconSrc: "/img/icons/1/hot-air-balloon.svg",
    title: "Quick Processing",
    text: "We prioritize fast and efficient visa approvals.",
  },
  {
    id: 3,
    iconSrc: "/img/icons/1/diamond.svg",
    title: "End-to-End Support",
    text: " From consultation to post-approval assistance, we’re with you at every step.",
  },
  {
    id: 4,
    iconSrc: "/img/icons/1/medal.svg",
    title: "High Success Rate",
    text: " Our meticulous approach guarantees a high success rate for visa approvals",
  },
  {
    id: 5,
    iconSrc: "/img/icons/3/4.svg",
    title: "Affordable Pricing",
    text: "Transparent and competitive fees with no hidden charges.",
  },
];
